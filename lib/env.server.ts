...
const serverEnvSchema = z.object({
  ...
  ACTIVE_SHOW_FILE: z.string().default(".active-show"),
  DEFAULT_LOCALE: z.enum(["de", "en", "es"]).default("de"),
  PUBLIC_SITE_URL: z.url().default("http://localhost:4321"),
  STUDIO_API_ORIGIN: z.url().default("http://localhost:8787"),
  STUDIO_BASE_PATH: z.string().default("/"),
  ...
  ELEVENLABS_ES_VOICE_ID: z.string().optional(),
